...
import { FaSpinner, FaCar, FaUserTie, FaCalendarCheck, FaStar, FaSync } from "react-icons/fa";
...
const GarageAdminOverview = () => {
  const { stats, loading, reloadStats } = useOutletContext();

  // Fetch fresh data when the overview component mounts
  useEffect(() => {
    if (reloadStats) {
      reloadStats();
    }
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Performance dashboard for all managed garages.</p>
        </div>
...
export default GarageAdminOverview;